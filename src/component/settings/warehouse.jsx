...
import {warehouseData, warehouseColumn, warehouseDel} from '../../model/warehouseModel';
...
class Warehouse extends Component {
    ...
    async componentDidMount(){
        ...
        this.setState({data: warehouse.data});
    }
        ...
        return [
            ...warehouseColumn(),
            {
                ...
                options: {
                    ...
                    return (
                        <RowAction> 
                            <li><Link  to={`/settings/warehouse/${this.state.selectedID}`}><i className="icon-pencil5"></i> Edit</Link></li>
    ...
    */
    ...
    render() { 
        return ( 
            <React.Fragment>
                <Main title="Warehouse" header="Warehouse">
                    <p><Link  className="btn btn-primary btn-labeled" to="/settings/warehouse/new" ><b><i className="icon-file-plus"></i></b>Add New Warehouse</Link></p>
                    <MUIDataTable
                        title={"Warehouse List"}
                        data={this.state.data}
                        columns={this.columns()}
                        options={this.options('warehouse_list.csv')}
                    />
                </Main>
            </React.Fragment>
         );
