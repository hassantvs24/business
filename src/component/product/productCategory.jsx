...
import {productCategoryData, productCategoryColumn, delProductCategory} from '../../model/productCategoryModel';
...
class ProductCategory extends Component {
        ...
        return [
            ...productCategoryColumn(),
            {
                ...
                options: {
                    ...
                    return (
                        <RowAction> 
                            <li><Link  to={`/products/category/${this.state.selectedID}`}><i className="icon-pencil5"></i> Edit</Link></li>
    ...
    */
    ...
    render() { 
        return ( 
            <React.Fragment>
                <Main title="Product Category" header="Product Category">
                <p><Link  className="btn btn-primary btn-labeled" to="/products/category/new" ><b><i className="icon-file-plus"></i></b>Add New Category</Link></p>

                <MUIDataTable
                        title={"Product Category List"}
                        data={this.state.data}
                        columns={this.columns()}
                        options={this.options('product_category_list.csv')}
                    />
